...
The operator $H$ satisfies the following identities for $p\ge 0$:
\begin{enumerate}
    \item $d_0^{p+1} H_p = \mathrm{id}_{X_p}$.
    \item $d_i^{p+1} H_p = H_{p-1} d_{i-1}^p$ for $i>0$.
\end{enumerate}
\end{lemma}
\begin{proof}
...
\textbf{Case $p=0$:} We verify $d_1^1 H_0 = H_{-1} d_0^0 = 0$.
